  ...
  return (
    ...
    <Container id="about">
      <Row className=' p-5 justify-content-center'>
        <Col lg="3">
          <h5 className='text-uppercase' id="about-title">About</h5> 
